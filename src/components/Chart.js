            ...
            <AreaChart data={data}>
                <defs>
                    <linearGradient id="chartColor" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor={darkMode ? "#4d7c0f" : "#84cc16"} stopOpacity={0.8}/>
                        <stop offset="95%" stopColor={darkMode ? "#4d7c0f" : "#84cc16"} stopOpacity={0}/>
                    </linearGradient>
                </defs>
                <Area 
                    type="monotone" 
                ...
                <Tooltip 
                    ...
                    itemStyle={darkMode ? {color: "#4ade80"} : null}
                />
                <XAxis dataKey={"date"} />
